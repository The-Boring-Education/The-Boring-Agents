...
class AptitudeQuestionGenerator(BaseAgent):
    ...
    def generate_questions(self, topic: str, count: int = MIN_QUESTIONS_PER_TOPIC) -> List[str]:
...
6. Questions should cover EASY, MEDIUM, and HARD difficulty levels.
7. Each question should be self-contained with all necessary data.
...
Questions:"""
        ...
        self.logger.info("Successfully generated %d questions.", len(result))
        return result
